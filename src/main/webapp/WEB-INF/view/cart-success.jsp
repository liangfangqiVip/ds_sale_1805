...
<div class="cartPro">
    ...
    <div class="shop_des">
        <a href="/toItemPage.do?skuId=${cart.skuId}&spuId=${cart.shpId}" target="_blank"><img src="images/shop_des.png"/></a>
    </div>
    <div class="shop_cart">
        <a href="/toCartListPage.do"><img src="images/shop_cart.png"/></a>
    </div>
</div>
